...
(* OASIS_START *)
(* DO NOT EDIT (digest: dbbe85b9016b08bccebc7a5ed7a97c21) *)
(*
...
# 1 "/usr/home/ermine/projects/ocaml/src/oasis/src/oasis/OASISSection.ml"
  open OASISTypes
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "Wrapper for Ocamlnet's HTML parser to produce plain text";
          description = None;
          categories = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/ermine/dehtml.git";
                      src_repo_browser =
                        Some "https://github.com/ermine/dehtml";
